...
Plants that grow in temperate environments are at risk of being exposed to late spring freezes, which can be detrimental to plant growth. According to Gu et al. %\citeyear{Gu2008}
...
In a study performed by Peterson and Abatzoglou %\citeyear{Peterson2014}
...
Temperate deciduous tree species must have plastic phenological responses in the spring in order to optimize photosynthesis and minimize frost or drought risk \citep{Polgar2011}. In a study performed by Vitasse et al. %\citeyear{Vitasse2013}
...
% Date and time: Thu, Dec 15, 2016 - 13:55:41
...
% Need to acknowledge the Lenz and Augspurger studies about budburst to leaf out and how leaf expansion is a riskier time. Actually, Augspurger paper really is a call for investigating this theory further. Did not prove anything just indicated general trend. Still okay!
...
\captionof{table}{Indicators for Modeling False Spring Risk and Damage}
\begin{siderules}
