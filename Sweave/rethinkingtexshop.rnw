...
%Xin 2016 - Second, the risk function should vary as a function of a number of factors as noted; however, a threshold for each individual biomeis used in this study for the purpose of simplicity. Observations have found that understory tends to have earlier timing of leaf springonset than overstory for the same forest site, possibly because understory species adopt strategies to take advantage of the high-lightperiod in spring before canopy development (Richardson and O’Keefe, 2009)
