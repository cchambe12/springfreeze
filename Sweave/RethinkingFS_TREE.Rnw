...
%EMW: You mention equation above, but have not told the audience about any equations, re-work the sentence/paragraph (probably best to remove 'equation'). %CJC: I had to delete 5 words but I tried to keep the content the same!
