...
\item It is therefore expected that high variation in spring temperatures may result in longer durations of vegetative risk.
...
\item By comparing the durations of vegetative risk to the average daily temperatures for each year, we found that... %%%% NEED TO CALCULATE!!!!!
\end{enumerate}
