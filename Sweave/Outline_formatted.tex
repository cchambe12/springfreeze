...
\item We outline in particular how life stage of the individual \citep{Caffarra2011}, location within a forest or canopy \citep{Augspurger2013}, winter chilling hours (Flynn \& Wolkovich 2017?), level of precipitation prior to the freezing event \citep{Anderegg2013}, freeze duration/intensity, and range limits of the species \citep{Martin2010} unhinge simple metrics of false spring. 
...
\begin {enumerate}
\item Temperate deciduous tree species use winter chilling hours, spring forcing temperatures, and photoperiod cues to optimize growth and minimize spring freeze damage \citep{Cleland2007, Polgar2011}.
...
\item Photoperiod sensitivity is a common false spring avoidance strategy: species that respond to photoperiod cues more than spring forcing temperatures will likely delay budburst and evade false spring events \citep{Basler2014}.
\\
\item Some temperate forest species have evolved to be more tolerant of spring freezing temperatures. 
\item Many temperate forest trees to have toothed or lobed leaves. 
\item These serations could permit greater packability into winter buds, thus reducing the metabolic requirements in the spring and increasing the rate of leaf out \citep{Edwards2017}.
\item Young temperate forest plant leaves also generally have more trichomes (i.e. small, unicellular hairs), which offer leaves greater protection against false springs once budburst has already initiated \citep{Agrawal2004}.
...
\begin{enumerate}
\item The current definition of a false spring fails to incorporate the different avoidance and tolerance strategies.
\item The equation and 7 day parameter assumes consistency across species, functional group, life stage, habitat type, and other climatic regimes, which is largely inadequate. 
\item Temperate forest individuals have evolved to optimize growth and minimize drought and frost damage. 
...
\item Seedlings and saplings initiate budburst before canopy closure in order to benefit from the increased light levels \citep {Augspurger2008}, which puts them at greater risk to false spring damage than adult trees \citep{Vitasse2014}.
...
\item This could potentially leading to crown dieback for the larger tree species, enhanced sun exposure to understory species and subsequently damage to the smaller species. 
\item False spring events could therefore adversely affect other trophic levels if fruit and seed development is impacted \citep{Gu2008}.
\end{enumerate}
...
\item This is evident through the high levels of genetic diversity for spring budburst to occur across temperate forest tree species \citep{Chuine2001}.
