...
\item With climate change progressing, these earlier, and potentially longer, springs could expose temperate forest plants to multiple false spring events during these sensitive foliate phenophases. 
\end{enumerate}
