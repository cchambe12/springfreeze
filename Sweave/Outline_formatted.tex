...
% \item Intracellular ice formation can cause defoliation, xylem embolism and decreased xylem conductivity which can result in crown dieback \citep{Gu2008}. %% Can we discuss keeping this line? There's a point that I would like to make later about how crown dieback from a false spring could cause increased sun exposure to understorey plants meaning false spring events can almost have a domino effect.
\end {enumerate}
...
Now we say, but WAIT! All this assumes plants as a monolith, when the reality is much more complex based on basic physiology and based on species differences 
...
\item Therefore, warm temperatures earlier in the year (i.e. in February) do not seem to induce budburst too early due to not enough accumulated chilling hours \citep{Basler2012}.
...
\item We assess the interaction between duration of vegetative risk and false spring events using two datasets: from a growth chamber chilling experiment and long-term observational data. % Set up below or here or both places, connections to climate change
\end {enumerate}
...
\item With climate change progressing, these earlier - and potentially longer - springs could expose temperate forest plants to multiple false spring events during the duration of vegetative risk phases. 
\end{enumerate}
...
\item Anthropogenic climate change could cause certain species to have insufficient winter chilling (especially at lower latitudes) resulting in higher spring forcing requirements \citep{McCreary1990, Morin2009, Fu2012, Polgar2014, Chuine2010}. 
...
\item With a changing climate, forcing temperatures will increase while photoperiod cues will remain stagnant, potentially elongating the duration of vegetative risk and exposing at risk plants to more intense false spring events or even multiple freezes. %% NEEDS FIXING!!
...
\item Future research should aim to integrate spatiotemporal effects and regional differences when investigating false spring risk in order to make better predictions.
\end {enumerate}
\end{enumerate}
