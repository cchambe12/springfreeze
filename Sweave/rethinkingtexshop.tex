...
\begin{center}
\captionof{table}{Number of False Springs along a Latitudinal Gradient in North America} \label{tab:title} 
\begin{tabular}{|c|c|c|c|c|}
\hline
Station & Elevation & Latitude & Longitude & False Springs \\
\hline
