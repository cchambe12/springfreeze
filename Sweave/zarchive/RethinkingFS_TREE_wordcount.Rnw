...
This cue interaction could potentially lead to longer durations of vegetative risk than if chilling conditions were expected to remain the same or increase and, thus, expose at risk plants to more intense false spring events or even multiple events in one year. 
