...
% EMW: I deleted ref to earth system models based on Ben's comments. I also removed the road map sentence from the middle of the abstract as it felt out of place. 
