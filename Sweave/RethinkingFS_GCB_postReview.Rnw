...
With spring advancing, species that have shorter durations of vegetative risk may avoid false springs more successfully than species that have much longer durations of vegetative risk. Understanding the various physiological and phenological mechanisms across species are crucial for species- or site-specific studies as well as ecosystem-wide models. By using multiple budburst dates across individuals and additionally including leafout data in our predictions, we will be better able to forecast false spring risk of damage as climate change progresses. 
...
%%% Need more here and to wrap it up! %%%
