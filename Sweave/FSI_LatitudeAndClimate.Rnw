...
stargazer(am.lm, eur.lm, no.space=TRUE, title ="The results from a linear regression model analyzing the relationship between latitude and frequency of false springs. 1) is from the North American transect and 2) is from the European transect.")
@
