...
source("ts.timeline.R")
source("dans.timeline.R")
...
<<label=fsifig, results=hide, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="A scatterplot indicating FSI values from 2008 to 2014 for each methdology used in this study. PhenoCam FSI values are red, Observed FSI values are blue, and USA-NPN FSI values are green.", fig.pos="H">>=
...
<<label=pearson, results=hide, echo=FALSE, warning=FALSE, message=FALSE>>=
pearson<-cor(FSI.table, method="pearson")
...
<<label=treespotters, results = hide, echo=FALSE, warning=FALSE, message= FALSE, fig.cap="A timeline plot indicating the duration of vegetative risk for each species studied at the Arnold Arboretum in 2016.", fig.pos="H">>=
...
<<label=chilling, results = hide, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="A timeline plot indicating the duration of vegetative risk for each species from experimental chillingsstudy.", fig.pos="H">>=
read_chunk("..//scripts/DF.plot.R")
