...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in table(budburst\$species): object 'budburst' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(data): object 'npn\_cam' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in summary(regression): object 'regression' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(regression): object 'regression' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'method' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(data): object 'npn\_obs' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in summary(regression.npn): object 'regression.npn' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(regression.npn): object 'regression.npn' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'obs.hf' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(data): object 'obs.hf' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in summary(regression.hf): object 'regression.hf' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(regression.hf): object 'regression.hf' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(blend.hf, aes(Year, FSI)): object 'blend.hf' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'FSI.table' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in pmax(FSI\_cam, 0): object 'FSI\_cam' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(false\_spring, aes(Year, FSI\_cam)): object 'false\_spring' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'method' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(hf.sh, aes(Year, FSI)): object 'hf.sh' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(bb, caption.placement = "{}top"{}): object 'bb' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xtable::xtable(FSI.table, caption = "{}False Spring Indices calculated using all three methodologies"{}): object 'FSI.table' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xtable::xtable(pearson, caption = "{}Pearson Correlation Coefficients shown comparing the strength of association between the FSI values calculated across all three methodologies."{}): object 'pearson' not found}}\end{kframe}
