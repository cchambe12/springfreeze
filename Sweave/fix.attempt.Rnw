...
\begin{document}
%\bibliographystyle{~/Documents/git/springfreeze/refs/lib.bib}
...
%print(xtable::xtable(FSI.table,caption = "False Spring Indices calculated using all three methodologi%es"),comment=FALSE, caption.placement="top")
%@
