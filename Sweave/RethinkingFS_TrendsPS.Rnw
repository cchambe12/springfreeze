...
{Chuine2010} probably play a dominant role. Most phenological studies currently focus on one phenophase (i.e. budburst or leafout) but, in order to examine false spring risk, it is crucial to examine the effects of the three phenological cues and their interactions on the duration of vegetative risk (i.e. both budburst and leafout).  

Such cues may provide a starting point for predicting how climate change will alter the duration of vegetative risk. Robust predictions will require much more information, especially the emissions scenario realized over coming decades \citep{IPCC2014}, but one potential outcome is that higher temperatures will increase forcing and decrease chilling in many locations. We used data from a recent study that manipulated the three cues and measured budburst and leafout \citep{Flynn2018}. To assess the effects of climate change, we looked at the effects of increased forcing, decreased photoperiod and decreased chilling (Figure \ref{fig:dan}) and compared this prediction to the more classic approach of increased forcing, chilling and photoperiod \citep{Basler2014, Laube2013}. Our results suggest a 2-5 day increase in duration of vegetative risk with increased forcing but decreased chilling and a 7-10 day increase in duration of vegetative risk with increased forcing and decreased photoperiod. These cue interactions could thus expose at-risk plants to more intense false spring events or even multiple events in one year.
...
\begin{figure} [H] 
 ...
 \caption{We examine the effects of phenological cues on the duration in vegatitive risk across three species with more forcing, shorter photoperiods, and less chill and their interactions. We compare the predicted shifts in phenological cues with climate change (i.e. more forcing with shorter photoperiod and more forcing with less chilling) to a more classical approach (i.e. more forcing with longer photoperiod and more forcing with more chilling) to show the expected increase in duration of vegetative risk with advancing budburst. To calculate the interation, we added the two estimated isolated effects to the interaction effect for each species.   }\label{fig:dan} 
 \end{center}
 \end{figure}
