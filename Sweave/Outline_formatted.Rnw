...
\item These earlier, and potentially longer, springs could expose temperate forest plants to multiple false spring events during these sensitive foliate phenophases. 
...
\item With a changing climate, forcing temperatures will increase while photoperiod cues will remain stagnant, potentially elongating the duration of vegetative risk and exposing at risk plants to more intense false spring events.%% NEEDS FIXING!!
