...
<<label=latmap, results = "asis", echo=FALSE, fig.cap="The number of false spring events along two latitudinal gradients: a) North America and b) Europe.", fig.pos="H">>=
read_chunk("..//scripts/Lat.Map.R")
# Upload US map
usa <- map_data("usa")
