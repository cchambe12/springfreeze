...
\item Species that are better able to phenologically track the shifts in spring advancement due to climate change are more likely to sustain damaging events such as false springs (might need to move this sentence now!) \citep{Scheifinger2003}. %% Probably will work in the conclusion!
