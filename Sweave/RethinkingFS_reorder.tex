...
\caption[Duration of vegetative risk across species for 1997 and 2012]{Duration of vegetative risk across species for 1997 and 2012. In 1997, the aggregated GDDs to budburst were the lowest and the duration of vegetative risk for each species are short, whereas in 2012, the aggregated GDDs to budburst were the highest and the duration of vegetative risk is higher. The dotted line indicates a False Spring event in 2012. The histogram at the bottom right corner indicates the frequency of accumulated GDDs to budburst for each year and indicates that 1997 is the lowest and 2012 is the highest. }\label{fig:hf}
\end{figure}
