...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'method' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'FSI.table' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(ile, aes(x = doy, y = risk)): object 'ile' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(bet, aes(x = doy, y = risk)): object 'bet' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in arrangeGrob(...): object 'ilemuc' not found}}\end{kframe}
