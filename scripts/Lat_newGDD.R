...
lat1$fs<- ifelse((lat1$count >= 200 & lat1$frz == "freeze"), TRUE, NA)
...
lat2$fs<- ifelse((lat2$count >= 200 & lat2$frz == "freeze"), TRUE, NA)
...
lat3$fs<- ifelse((lat3$count >= 200 & lat3$frz == "freeze"), TRUE, NA)
...
lat4$fs<- ifelse((lat4$count >= 200 & lat4$frz == "freeze"), TRUE, NA)
...
lat6$fs<- ifelse((lat6$count >= 200 & lat6$frz == "freeze"), TRUE, NA)
...
lat7$fs<- ifelse((lat7$count >= 200 & lat7$frz == "freeze"), TRUE, NA)
...
lat8$fs<- ifelse((lat8$count >= 200 & lat8$frz == "freeze"), TRUE, NA)
...
lat9$fs<- ifelse((lat9$count >= 200 & lat9$frz == "freeze"), TRUE, NA)
...
lat10$fs<- ifelse((lat10$count >= 200 & lat10$frz == "freeze"), TRUE, NA)
...
lat11$fs<- ifelse((lat11$count >= 200 & lat11$frz == "freeze"), TRUE, NA)
