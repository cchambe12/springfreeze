...
model {
	...
	mu_b_chill1 ~ normal(0, 30);
	mu_b_chill2 ~ normal(0, 30);
	mu_b_site ~ normal(0, 30);
	...
	sigma_b_warm ~ normal(0, 15); // Start big at 10, go smaller if introduces problems
	sigma_b_photo ~ normal(0, 15); 
	sigma_b_chill1 ~ normal(0, 15);
	sigma_b_chill2 ~ normal(0, 15);
	sigma_b_site ~ normal(0, 15);
